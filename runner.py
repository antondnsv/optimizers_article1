...
if __name__ == '__main__':
    ...
    if args['mode'] == 'plot':
        ...
        time_pyomo = data.groupby(['N'])['pyomo_ipopt'].median()
        time_scipy = data.groupby(['N'])['scipy_cobyla'].median()
        ...
        plt.title('Медианное время решения задач через Pyomo.ipopt и SciPy.cobyla')
        plt.grid()
